...
import '/main.dart';
import '/screens/blog/blog_repository.dart';
import '/screens/blog/component/blog_detail_header_component.dart';
                  ...
                  Row(
                    ...
                    children: [
                      if (data.blogDetail!.createdAt.validate().isNotEmpty)
                        Row(
                          children: [
                            ...
                            Text(data.blogDetail!.createdAt.validate(),
                      ...
                      if (data.blogDetail!.totalViews != 0)
                        Row(
                          mainAxisAlignment:
                              data.blogDetail!.createdAt.validate().isNotEmpty
                          ...
                          children: [
                            ...
                            8.width,
                            Text('${data.blogDetail!.totalViews.validate()} ',
                                style: boldTextStyle()),
                            Text(language.views,
                                style: secondaryTextStyle(),
                                maxLines: 1,
