...
import '/screens/booking/component/booking_service_step1.dart';
import '/screens/booking/component/edit_booking_service_dialog.dart';
            ...
            child: Column(
              children: [
                ...
                if (bookingData.handyman.validate().isNotEmpty &&
                    ...
                    bookingData.handyman!.first.handyman != null)
                  Column(
                    children: [
                      Divider(height: 0, color: context.dividerColor),
                      Row(
    ...
    try {
      if (bookingData.bookingSlot != null) {
        final bookingDateTimeForTimeSlots =
            bookingData.date.validate().split(" ").isNotEmpty
                ? bookingData.date.validate().split(" ").first
                : "";
        ...
        return DateTime.parse(bookingData.date.validate())
            .isAfter(DateTime.now());
      }
    } catch (e) {
      debugPrint('E: $e');
